...
export default RegisterPage;
                        <p className="govuk-body-l">Create an account to apply for funeral expenses payment.</p>
                        ...
                        <form onSubmit={handleSubmit} className="govuk-form">
                            ...
                            <button className="govuk-button" data-module="govuk-button" disabled={loading}>
                                {loading ? "Creating account..." : "Create account"}
                            </button>
                        </form>
                        ...
                        <h2 className="govuk-heading-m">Already have an account?</h2>
                        <p className="govuk-body">
                            <Link to="/" className="govuk-link">Sign in to your account</Link>
                        </p>
                    </div>
                </div>
            </main>
